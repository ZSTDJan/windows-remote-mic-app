...
- PySide6/Qt Quick 四页桌面程序、通知区域控制、分项检查和 PyInstaller/Inno Setup 构建。

当前版本是**已获得部分真实硬件验证、仍待完整复测的源码/构建候选**：真实
RC003 已验证多候选连接、13 个实体按键在映射页识别、记事本普通映射、有效语音
