...
![谷歌遥控器按键设置界面](docs/screenshots/google-buttons.jpg)

![小米遥控器按键设置界面](docs/screenshots/xiaomi-buttons.jpg)
...
- 按住话筒键说话，在文字输入框中使用搜狗、微信或豆包输入法输入文字。
...
2. 选择搜狗、微信或豆包输入法，核对“语音按键”与输入法的**按住说话快捷键**一致；自动读取失败时可手动录入。
3. 先在记事本中用电脑键盘试这个快捷键，确认能打开语音输入。再把光标留在文字框里，按住遥控器话筒键说话，松开结束。
...
**谷歌遥控器按键：**为单击、双击、长按分别选择动作。

![谷歌遥控器按键设置界面](docs/screenshots/google-buttons.jpg)

**小米遥控器按键：**按同样的方式设置实体按键。

![小米遥控器按键设置界面](docs/screenshots/xiaomi-buttons.jpg)

**设备：**选择遥控器，查看配对、连接和服务状态。

![无线麦设备界面](docs/screenshots/device-overview.jpg)

**语音：**选择音频端点、输入法和语音快捷键。

![无线麦语音界面](docs/screenshots/voice-overview.jpg)
