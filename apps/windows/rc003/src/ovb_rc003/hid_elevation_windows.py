...
HELPER_EXIT_HOST_RESTARTED = 45
HELPER_EXIT_LEGACY_RUNTIME_RESTART_REQUIRED = 46
...
_HELPER_RUNTIME_EXIT_ERROR_DETAILS = {
    ...
    HELPER_EXIT_HOST_RESTARTED: "hid_helper_host_restarted",
    HELPER_EXIT_LEGACY_RUNTIME_RESTART_REQUIRED: "hid_helper_legacy_runtime_restart_required",
}
